...
\begin{figure}[!t]
	\centering{
    	\begin{subfigure}[t]{0.25\columnwidth}
          	\includegraphics[trim={26cm 10cm 24cm 10cm}, clip, width=\columnwidth]{multi_discount_raw_3D_1min_ss.jpg}
        		\caption{$1$ min}
    	\end{subfigure}
	\hspace*{0.05\textwidth}
    	\begin{subfigure}[t]{0.25\columnwidth}
          	\includegraphics[trim={26cm 10cm 24cm 10cm}, clip, width=\columnwidth]{multi_discount_raw_3D_2min_ss.jpg}
        		\caption{$2$ min}
    	\end{subfigure}
	\hspace*{0.05\textwidth}
	\begin{subfigure}[t]{0.25\columnwidth}
          	\includegraphics[trim={26cm 10cm 24cm 10cm}, clip, width=\columnwidth]{multi_discount_raw_3D_3min_ss.jpg}
        		\caption{$3$ min}
    	\end{subfigure}
	}
	\centering{
	\begin{subfigure}[t]{0.25\columnwidth}
          	\includegraphics[trim={26cm 10cm 24cm 10cm}, clip, width=\columnwidth]{multi_discount_raw_3D_4min_ss.jpg}
        		\caption{$4$ min}
    	\end{subfigure}
	\hspace*{0.05\textwidth}
    	\begin{subfigure}[t]{0.25\columnwidth}
          	\includegraphics[trim={26cm 10cm 24cm 10cm}, clip, width=\columnwidth]{multi_discount_raw_3D_5min_ss.jpg}
        		\caption{$5$ min}
    	\end{subfigure}
	\hspace*{0.05\textwidth}
    	\begin{subfigure}[t]{0.25\columnwidth}
          	\includegraphics[trim={26cm 10cm 24cm 10cm}, clip, width=\columnwidth]{multi_discount_raw_3D_6min_ss.jpg}
        		\caption{$6$ min}
    	\end{subfigure}
	}
	\centering{
   	\begin{subfigure}[t]{0.25\columnwidth}
          	\includegraphics[trim={26cm 10cm 24cm 10cm}, clip, width=\columnwidth]{multi_discount_raw_3D_7min_ss.jpg}
        		\caption{$7$ min}
    	\end{subfigure}
 	\hspace*{0.05\textwidth}
    	\begin{subfigure}[t]{0.25\columnwidth}
          	\includegraphics[trim={26cm 10cm 24cm 10cm}, clip, width=\columnwidth]{multi_discount_raw_3D_8min_ss.jpg}
        		\caption{$8$ min}
    	\end{subfigure}
	\hspace*{0.05\textwidth}
    	\begin{subfigure}[t]{0.25\columnwidth}
          	\includegraphics[trim={26cm 10cm 24cm 10cm}, clip, width=\columnwidth]{multi_discount_raw_3D_9min_ss.jpg}
        		\caption{$9$ min}
    	\end{subfigure}
	}
...
%	% trim={<left> <lower> <right> <upper>}
%		\centering{
%			\subfigure[$0$ min]{\includegraphics[trim={22cm 5cm 16cm 3.5cm}, clip, height=0.45\columnwidth]{multi_discount_raw_2D_0min.jpg}}
%			\hspace*{0.025\columnwidth}
%			\subfigure[$1$ min]{\includegraphics[trim={22cm 5cm 16cm 3.5cm}, clip, height=0.45\columnwidth]{multi_discount_raw_2D_1min.jpg}}
%		}
%		\vspace*{0.025\columnwidth}
%		\centering{
%			\subfigure[$2$ min]{\includegraphics[trim={22cm 5cm 16cm 3.5cm}, clip, height=0.45\columnwidth]{multi_discount_raw_2D_2min.jpg}}
%			\hspace*{0.025\columnwidth}
%			\subfigure[$3$ min]{\includegraphics[trim={22cm 5cm 16cm 3.5cm}, clip, height=0.45\columnwidth]{multi_discount_raw_2D_3min.jpg}}
%		}
%		\vspace*{0.025\columnwidth}
%		\centering{
%			\subfigure[$4$ min]{\includegraphics[trim={22cm 5cm 16cm 3.5cm}, clip, height=0.45\columnwidth]{multi_discount_raw_2D_4min.jpg}}
%			\hspace*{0.025\columnwidth}
%			\subfigure[$5$ min]{\includegraphics[trim={22cm 5cm 16cm 3.5cm}, clip, height=0.45\columnwidth]{multi_discount_raw_2D_5min.jpg}}
%		}
%		\vspace*{0.025\columnwidth}
%		\centering{
%			\subfigure[$6$ min]{\includegraphics[trim={22cm 5cm 16cm 3.5cm}, clip, height=0.45\columnwidth]{multi_discount_raw_2D_6min.jpg}}
%			\hspace*{0.025\columnwidth}
%			\subfigure[$7$ min]{\includegraphics[trim={22cm 5cm 16cm 3.5cm}, clip, height=0.45\columnwidth]{multi_discount_raw_2D_7min.jpg}}
%		}
%		\vspace*{0.025\columnwidth}
%		\centering{
%			\subfigure[$8$ min]{\includegraphics[trim={22cm 5cm 16cm 3.5cm}, clip, height=0.45\columnwidth]{multi_discount_raw_2D_8min.jpg}}
%			\hspace*{0.025\columnwidth}
%			\subfigure[$9$ min]{\includegraphics[trim={22cm 5cm 16cm 3.5cm}, clip, height=0.45\columnwidth]{multi_discount_raw_2D_9min.jpg}}
%		}
%		\vspace*{0.025\columnwidth}
%		\caption{2D Projected Occupancy Grid Map of SEH Second Floor}
%			\label{fig:sim2Dmaps}
