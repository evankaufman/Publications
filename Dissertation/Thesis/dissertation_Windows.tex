\documentclass[thesis,draft]{thesis-gwu}
...
% TODO list:
% Include "This is the final and approved form of the dissertation." in first draft?
% Consistent figure labeling
% Names: gray, collision avoidance, collision-free, multi-vehicle, $ sec, commas in numbers >= 10,000, real-time
