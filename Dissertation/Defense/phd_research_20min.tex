...
\begin{itemize}
	...
	\begin{itemize}
		\item Robots can replace humans dangerous/uncertain tasks such as surveillance, combat, and search-and-rescue
		\item Key question: when robots explore new spaces, how can they maximize their knowledge about their environment?
	\end{itemize}
	\pause
	\item Robotic Capabilities
	\begin{itemize}
		\item Robot must understand their environment by generating a map, referred to as \emph{mapping}
		\item Selecting and performing robotic actions to maximize map information, referred to as \emph{autonomous exploration}
...
\begin{itemize}
	...
	\item A numerical simulation shows that this approach can be extended to 3D environments
\end{itemize}
