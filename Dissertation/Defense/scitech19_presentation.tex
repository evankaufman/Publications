...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Humans cannot control rovers directly in real-time due to a time delay from Earth
	\end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Optimal planning to maximize information gain for a \emph{flying} Mars robot
...
\begin{itemize}
	\item Bayesian Framework with a Markov Assumption: latest a priori cell occupancy probabilities capture the information from all prior observations
\vspace*{0.0cm}\pause
...
\begin{itemize}
	...
	\begin{itemize}
		\item Each trajectory is solved independently as a function of time, i.e. $x(t)$, $y(t)$, and $z(t)$
...
\begin{figure}
	...
	\begin{subfigure}[t]{0.45\columnwidth}
           	\centering
          	\includegraphics[height=0.5\textwidth]{connected_costmap.png}
...
\begin{frame}
	...
	\begin{itemize}
		\item Expected information gain of several poses in 3D space capturing complex obstacles while flying
...
\begin{frame}
\frametitle{Simulation and Experiment Summary}
\begin{itemize}
...
\begin{itemize}
	...
	\item Exact mapping concepts are extended to map uncertainty to accomplish \emph{autonomous exploration} for a flying vehicle above the surface of Mars
	\item These are demonstrated with a Mars simulation and a flight experiment
\end{itemize}
\end{frame}
