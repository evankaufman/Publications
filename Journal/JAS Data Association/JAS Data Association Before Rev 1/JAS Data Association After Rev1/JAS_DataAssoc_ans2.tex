...
\begin{correction}
Then, a close approximation of the probability that the $i$-th system is associated with the $j$-th measurement is (from [1])
\begin{align*}
\label{eqn:betaDef}
...
The paper is revised with (39) written as follows:
...
%The angular RMS errors are important, particularly in the angles-only GEO cases. One would expect that the direction of the objects would be very accurate, even if the positions were not.
