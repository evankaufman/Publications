...
%When these are prevalent, a fixed value of $B$ in \refeqn{betaDef} was found from simulations to provide a close approximation of $\beta_{ij}$ in various applications, though tuning this parameter is beyond the scope of this paper.
