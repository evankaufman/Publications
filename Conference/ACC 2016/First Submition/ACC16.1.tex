...
\centerline{
	\subfigure[Entropy map at $t=20$ (exact)]
		{\hspace*{0.3cm}\includegraphics[height=0.4\columnwidth]{Compare_ISM_H.pdf}\hspace*{0.3cm}
	}
	\subfigure[Entropy map at $t=20$  (approx.)]
		{\hspace*{0.3cm}\includegraphics[height=0.4\columnwidth]{Compare_Approx_H.pdf}\hspace*{0.3cm}
	}
}
